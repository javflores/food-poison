...
var _user$project$Food_Models$new = {id: 0, name: ' ', caloriesPerHundredGrams: 0.0};
var _user$project$Food_Models$Food = F3(
	function (a, b, c) {
		return {id: a, name: b, caloriesPerHundredGrams: c};
	});

var _user$project$Food_Messages$FetchAllFail = function (a) {
	return {ctor: 'FetchAllFail', _0: a};
};
var _user$project$Food_Messages$FetchAllDone = function (a) {
	return {ctor: 'FetchAllDone', _0: a};
};

var _user$project$Food_Commands$fetchAllUrl = 'http://localhost:4000/api/food';
var _user$project$Food_Commands$memberDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Food_Models$Food,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'caloriesPerHundredGrams', _elm_lang$core$Json_Decode$float));
var _user$project$Food_Commands$collectionDecoder = _elm_lang$core$Json_Decode$list(_user$project$Food_Commands$memberDecoder);
var _user$project$Food_Commands$fetchAll = A3(
	_elm_lang$core$Task$perform,
	_user$project$Food_Messages$FetchAllFail,
	_user$project$Food_Messages$FetchAllDone,
	A2(_evancz$elm_http$Http$get, _user$project$Food_Commands$collectionDecoder, _user$project$Food_Commands$fetchAllUrl));

var _user$project$Food_List$foodRow = function (food) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(food.name)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(food.caloriesPerHundredGrams))
					]))
			]));
};
var _user$project$Food_List$list = function (food) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Calories/100gr')
											]))
									]))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _user$project$Food_List$foodRow, food))
					]))
			]));
};
var _user$project$Food_List$nav = function (food) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Food_List$view = function (food) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Food_List$nav(food),
				_user$project$Food_List$list(food)
			]));
};

var _user$project$Food_Update$update = F2(
	function (action, food) {
		var _p0 = action;
		if (_p0.ctor === 'FetchAllDone') {
			return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return {ctor: '_Tuple2', _0: food, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});

var _user$project$Src_Messages$FoodMessage = function (a) {
	return {ctor: 'FoodMessage', _0: a};
};

var _user$project$Src_Models$initialModel = {
	food: _elm_lang$core$Native_List.fromArray(
		[])
};
var _user$project$Src_Models$Model = function (a) {
	return {food: a};
};
...
var _user$project$Src_Update$update = F2(
	function (message, model) {
		var _p0 = message;
		var _p1 = A2(_user$project$Food_Update$update, _p0._0, model.food);
		var updatedFood = _p1._0;
		var cmd = _p1._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{food: updatedFood}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Src_Messages$FoodMessage, cmd)
		};
	});

var _user$project$Src_View$page = function (model) {
	return A2(
		_elm_lang$html$Html_App$map,
		_user$project$Src_Messages$FoodMessage,
		_user$project$Food_List$view(model.food));
};
var _user$project$Src_View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Src_View$page(model)
			]));
};
...
var _user$project$FoodPoisoning$init = {
	ctor: '_Tuple2',
	_0: _user$project$Src_Models$initialModel,
	_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Src_Messages$FoodMessage, _user$project$Food_Commands$fetchAll)
};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['FoodPoisoning'], 'FoodPoisoning', typeof _user$project$FoodPoisoning$main === 'undefined' ? null : _user$project$FoodPoisoning$main);
